...
这次不是新增结算逻辑，而是把已有能力讲清楚：项目不只是“夜晚候选”，还会自动整理玩家夜晚行动并生成技能结果结算候选；但这些结果必须经过说书人确认、修改或手动裁定后才生效。

### 用户现在能看到什么变化

- README 的项目简介、功能亮点和流程图都明确写出“automatic skill-result settlement candidates”。
- `docs/FEATURES.md` 新增“自动技能结果结算候选”章节。
- 截图说明里把夜晚流程解释为“自动结算候选 + 说书人确认”，不是简单的夜序展示。

### Before / After

| Before | After |
| --- | --- |
| 对外看起来像只做夜序和候选提示 | 明确展示会整理行动并生成技能结果结算候选 |
| 自动能力被 AI 边界文案盖住 | 单独强调规则自动化/技能结算边界 |
| 容易误解成全自动裁判或完全没有自动结算 | 明确是“候选结果自动生成，说书人确认后生效” |

### 风险和注意

- 没有把项目包装成全自动规则引擎；复杂角色、毒醉、错误信息、恶魔伪装等仍然要求说书人裁定。
- 这轮主要是公开说明优化，不改变运行时代码。
...
- 欢迎页文案先改成“非官方说书人辅助工具”，随后同步为“非官方 AI 说书人副驾驶”，不再写“官方魔典”。
...
1. 打开 GitHub README，确认首屏是“非官方 AI 说书人副驾驶”，且不出现 PI / 集石 Logo。
